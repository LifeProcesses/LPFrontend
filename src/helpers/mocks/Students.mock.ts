    ...
    interviews: [
        {
            ...
            comments: [
                ...
                },
                {
                    ...
                    timestamp: new Date(),
                    text: 'Провели собеседования с HR и тимлидом фронтэндеров. Решение вынесут в течение недели.',
                },
                {
                    author: {
                        id: 1,
                    ...
                    timestamp: new Date(),
                    text: 'Отправил резюме, договорились о дате собеседования',
                },
            ],
        },
        {
            ...
            comments: [
                {
                    ...
                    timestamp: new Date(),
                    text: 'Получил оффер, но хочу дождаться ответа от NTR',
                },
            ],
        },
        {
